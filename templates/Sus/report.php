...
<div class="card2">
	<div class="header">
		<div class="panel_card2_title">Sus Report</div>
...
<div class="row">
	<div class="col-md-4">
		<div class="card2">
			<div class="header">
				<div class="panel_card2_title">Sus Statistic (Year: <?= date('Y'); ?>)</div>
				<div class="panel_card2_subtitle"><?= $organization_name; ?></div>
			</div>
	...
	<div class="col-md-8">
		<div class="card2">
			<div class="header">
				<div class="panel_card2_title">Sus Statistic Charts (Year: <?= date('Y'); ?>)</div>
				<div class="panel_card2_subtitle"><?= $organization_name; ?></div>
			</div>
			<div class="body">
				<div class="row">
