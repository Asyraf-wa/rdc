...
<div class="card2">
	<div class="header">
				<div class="panel_card2_title">Sus Disposed List</div>
		...
		<div class="body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
						<?= $this->Form->postLink(__('<i class="far fa-trash-alt"></i> Delete'), ['action' => 'delete', $sus->id], ['confirm' => __('Are you sure you want to delete # {0}?', $sus->id), 'class' => 'btn btn-outline-danger btn-xs', 'escape' => false]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
