...
<div class="card2">
	<div class="header">
		<div class="panel_card2_title">Questions Report</div>
...
<div class="row">
	<div class="col-md-4">
		<div class="card2">
			<div class="header">
				<div class="panel_card2_title">Questions Statistic (Year: <?= date('Y'); ?>)</div>
				<div class="panel_card2_subtitle"><?= $organization_name; ?></div>
			</div>
	...
	<div class="col-md-8">
		<div class="card2">
			<div class="header">
				<div class="panel_card2_title">Questions Statistic Charts (Year: <?= date('Y'); ?>)</div>
				<div class="panel_card2_subtitle"><?= $organization_name; ?></div>
			</div>
			<div class="body">
				<div class="row">
...
var monthYearChart = new Chart(ctx, {
    ...
    options: {
		title: {
			display: true,
			text: 'Questions Monthly Created'
		},
	legend: {
		display: false,
		position: 'top',
...
var chartOptions = {
	title: {
		display: true,
		text: 'Questions: Yearly Comparison'
	},
  legend: {
    display: true,
    position: 'top',
...
var quaterYearChart = new Chart(ctx, {
	...
	title: {
		display: true,
		text: 'Questions Registered by Quater'
	},
	legend: {
		display: false,
		position: 'top',
