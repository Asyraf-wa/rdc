...
<div class="card2">
	<div class="header">
				<div class="panel_card2_title">Questions Archived</div>
		...
		<div class="body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('<i class="far fa-folder-open"></i> View'), ['action' => 'view', $question->id], ['class' => 'btn btn-outline-success btn-xs', 'escape' => false]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
