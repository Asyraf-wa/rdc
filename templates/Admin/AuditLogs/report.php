...
<div class="card2">
	<div class="header">
		<div class="panel_card2_title">Audit Logs Report</div>
...
<div class="row">
	<div class="col-md-4">
		<div class="card2">
			<div class="header">
				<div class="panel_card2_title">Audit Logs Statistic (Year: <?= date('Y'); ?>)</div>
				<div class="panel_card2_subtitle"><?= $organization_name; ?></div>
			</div>
	...
	<div class="col-md-8">
		<div class="card2">
			<div class="header">
				<div class="panel_card2_title">Audit Logs Statistic Charts (Year: <?= date('Y'); ?>)</div>
				<div class="panel_card2_subtitle"><?= $organization_name; ?></div>
			</div>
			<div class="body">
				<div class="row">
...
var monthYearChart = new Chart(ctx, {
    ...
    options: {
		title: {
			display: true,
			text: 'Audit Logs Monthly Created'
		},
	legend: {
		display: false,
		position: 'top',
...
var chartOptions = {
	title: {
		display: true,
		text: 'Audit Logs: Yearly Comparison'
	},
  legend: {
    display: true,
    position: 'top',
...
var quaterYearChart = new Chart(ctx, {
	...
	title: {
		display: true,
		text: 'Audit Logs Registered by Quater'
	},
	legend: {
		display: false,
		position: 'top',
